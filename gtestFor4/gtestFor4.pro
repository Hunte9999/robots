...
win32:CONFIG(release, debug|release): LIBS += -L../../../../usr/local/lib/release/ -lgtest -pthread
else:win32:CONFIG(debug, debug|release): LIBS += -L../../../../usr/local/lib/debug/ -lgtest -pthread
else:unix: LIBS += -L../../../../usr/local/lib/ -lgtest -pthread

INCLUDEPATH += ../../../../usr/src/gtest
DEPENDPATH += ../../../../usr/src/gtest
