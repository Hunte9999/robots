...
private:
    ...
    std::map<component*, paircoord> lastPlaces;
protected:
...
public:
    ...
    int offModulesEnergyLack();

    int onModulesEnoughEnergy(int energy);
    ...
    const Vector<component*> &getRobots() const { return robots; }
